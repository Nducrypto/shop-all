...
export type SetProductsUpdater=(value:(prev:AllProductState)=>AllProductState)=>void
...
export const updateCurrentId = (setProduct: SetProductsUpdater, productId: string) => {
